...
class InputGeom
{
	...
	///@}
	/// 
	ImportScene m_vImportScene;
	
	bool loadMesh(class rcContext* ctx, const std::string& filepath);
	bool loadGeomSet(class rcContext* ctx, const std::string& filepath);
	bool loadBinInfo(class rcContext* ctx, const std::string& filepath);
	void LoadMeshFormat(BufferStream& stream);
	void LoadTerrainFormat(BufferStream& stream);
public:
	InputGeom();
	~InputGeom();
